...
public class UsuarioController {
    ...
    public Usuario obtenerPorNombreUsuario(@PathVariable String nombreUsuario) {
    ...
    public boolean confirmarVerificacion(
        ...
        return usuarioServicio.confirmarVerificacionCorreo(
                request.getCorreo(), request.getCode());
    }

    @GetMapping("/{id}/estadisticas")
    public EstadisticasUsuarioDTO obtenerEstadisticas(@PathVariable Long id) {
        return usuarioServicio.calcularEstadisticas(id);
    }
}